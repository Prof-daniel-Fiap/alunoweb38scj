...
export class TurmaComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.turmaService
      ...
      .subscribe(
        (res: HttpResponse<ITurma[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: ITurma[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
